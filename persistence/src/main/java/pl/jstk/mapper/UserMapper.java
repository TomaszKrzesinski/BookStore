...
public class UserMapper {
	...
	public static UserTo map(UserEntity userEntity) {
		if (userEntity != null) {
			return new UserTo(userEntity.getId(), userEntity.getUserName(), userEntity.getPassword(), userEntity.isEnabled(), userEntity.getRole());
		}
		return null;
	}
	...
	public static UserEntity map(UserTo userTo) {
		if (userTo != null) {
			return new UserEntity(userTo.getId(), userTo.getUserName(), userTo.getPassword(), userTo.isEnabled(), userTo.getRole());
		}
		return null;
	}
