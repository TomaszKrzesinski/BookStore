...
insert into user (id, user_name, password, enabled, role) values (1, 'admin', 'admin', true, 'ADMIN');
insert into user (id, user_name, password, enabled, role) values (2, 'Tomasz', 'tomasz', true, 'ADMIN');
insert into user (id, user_name, password, enabled, role) values (3, 'Marek', 'marek', true, 'USER');
insert into user (id, user_name, password, enabled, role) values (4, 'Damian', 'damian', true, 'USER');