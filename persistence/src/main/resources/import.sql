...
insert into user (id, user_name, password) values (1, 'admin', 'admin', 'ADMIN');
insert into user (id, user_name, password) values (2, 'Tomasz', 'tomasz', 'ADMIN');
insert into user (id, user_name, password) values (3, 'Marek', 'marek', 'USER');
insert into user (id, user_name, password) values (4, 'Damian', 'damian', 'USER');